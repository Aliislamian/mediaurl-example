...
const sdk_1 = require("@mediaurl/sdk");
const exampleAddon = (0, sdk_1.createAddon)({
    id: "example",
    name: "example",
    version: "0.0.0",
    ...
    const items = [
        {
            ...
            images: {
                poster: "https://m.media-amazon.com/images/M/MV5BNmMxYTE3MjctYTczYy00NjM3LWJiMDgtMzExMjZkYWU3NWRmXkEyXkFqcGdeQXVyMjgwMjk0NzA@._V1_SY999_CR0,0,706,999_AL_.jpg",
            },
        },
        {
            type: "movie",
            ...
            year: 2013,
            images: {
                poster: "https://img.cgmodel.com/image/2017/0519/cover/199976-1925301452.jpg",
            },
        },
    ];
    return {
...
exampleAddon.registerActionHandler("item", async (input, ctx) => {
    ...
    if (input.type === "movie" &&
        ...
        return {
            ...
            description: 'This is a good example item where we will show how to use the "source", "subtitle" and "resolve" handler',
    ...
    if (query.includes("big") &&
        ...
        return {
            ...
            description: "Big Buck Bunny (code-named Project Peach) is a 2008 short computer-animated comedy film featuring animals of the forest, made by the Blender Institute, part of the Blender Foundation.",
        };
    }
...
exampleAddon.addResolveHandler(new RegExp("//videocnd.example.com/resolve-example/(.*)"), async (match, input, ctx) => {
...
exampleAddon.addResolveHandler(new RegExp("//test-videos.co.uk/(.*)"), async (match, input, ctx) => {
